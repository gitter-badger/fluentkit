...
(function(process) {
  (function(modules) {
      ...
      var bind = {
        ...
        handleSingle: function handleSingle(attr, value) {
          if (!this.descriptor.interp && attrWithPropsRE.test(attr) && attr in this.el) {
            this.el[attr] = attr === 'value' ? value == null ? '' : value : value;
          }
    ...
    Url.transforms = [__webpack_require__(6), __webpack_require__(8), __webpack_require__(9), __webpack_require__(10)];
    ...
    Http.interceptors = [__webpack_require__(17), __webpack_require__(18), __webpack_require__(19), __webpack_require__(21), __webpack_require__(22), __webpack_require__(23), __webpack_require__(24)];
    Http.headers = {
      put: jsonType,
      post: jsonType,
      patch: jsonType,
    ...
    describe('this.$http', function() {
      it('get: test.json', function(done) {
        var vm = new Vue({created: function() {
    ...
    describe('Vue.promise ' + (isNative ? '(native)' : '(polyfill)'), function() {
      ...
      it('duplicate', function(done) {
        Promise.all([Promise.resolve(1).then(function(value) {
          expect(value).toBe(1);
      ...
      it('no chain breaking', function(done) {
        ...
        Promise.all([promise.catch(function() {
