...
<head>
    ...
    <meta name="object.test" content='{"test": "object", "with": ["array", "items"]}'>
    <meta name="user" content='{"id": 1}'>
...
<div class="app-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    <header class="app-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
            <span class="mdl-layout-title">@yield('page.title') @{{ app.data.url }}</span>
...
<script src="{{ url('js/common.bundle.js') }}"></script>
<script src="{{ url('js/admin.bundle.js') }}"></script>
<script src="{{ url('js/home.bundle.js') }}"></script>
</body>
</html>
