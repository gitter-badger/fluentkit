<template id="admin-roles-edit-template">
    <div id="admin-roles-edit">
        <validator name="validator">
            <div class="mdl-card mdl-shadow--2dp roles-edit-card">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">{{ trans('admin.roles_edit_title') }}</h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <p>{{ trans('admin.roles_edit_description') }}</p>
                </div>

                <div class="mdl-card__menu">
                    <a href="{{ route('admin.roles') }}" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect">
                        ...
                        <div class="role-fields">
                            <div class="admin-role-field mdl-grid">
                                ...
                                <div class="mdl-cell mdl-cell--9-col">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-dirty" v-bind:class="{'is-invalid': $validator.name.errors && $validator.name.touched, 'is-dirty': true}">
                            ...
                            <div class="admin-role-field mdl-grid">
                                ...
                                <div class="mdl-cell mdl-cell--9-col">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-dirty" v-bind:class="{'is-invalid': $validator.label.errors && $validator.label.touched, 'is-dirty': true}">
                                        <input class="mdl-textfield__input" type="text" id="role-label" :value="role.label" v-model="role.label" v-validate:label="{
                                    ...
                                    <div class="mdl-grid">
                                        @foreach(\App\Models\Permission::all() as $permission)
                                            <div class="mdl-cell mdl-cell--4-col">
                                                <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" v-bind:class="{'is-checked': role.permissions.indexOf('{{ $permission->name }}') !== -1}">
