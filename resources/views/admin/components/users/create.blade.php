<template id="admin-users-create-template">
    <div id="admin-users-create">
        <validator name="validator">
            <div class="mdl-card mdl-shadow--2dp users-create-card">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">{{ trans('admin.users_create_title') }}</h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <p>{{ trans('admin.users_create_description') }}</p>
                </div>
                        ...
                        <div class="user-fields">
                            <div class="admin-user-field mdl-grid">
                                ...
                                <div class="mdl-cell mdl-cell--9-col">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" v-bind:class="{'is-invalid': $validator.first_name.errors && $validator.first_name.touched}">
                            ...
                            <div class="admin-user-field mdl-grid">
                                ...
                                <div class="mdl-cell mdl-cell--9-col">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" v-bind:class="{'is-invalid': $validator.last_name.errors && $validator.last_name.touched}">
                            ...
                            <div class="admin-user-field mdl-grid">
                                ...
                                <div class="mdl-cell mdl-cell--9-col">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" v-bind:class="{'is-invalid': $validator.email.errors && $validator.email.touched}">
                            ...
                            <div class="admin-user-field mdl-grid">
                                ...
                                <div class="mdl-cell mdl-cell--9-col">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" v-bind:class="{'is-invalid': $validator.password.errors && $validator.password.touched}">
                                        <input class="mdl-textfield__input" type="password" id="user-password" v-model="user.password" v-validate:password="{
                                            required: {rule: true, message: '{{ trans('validation.required', ['attribute' => trans('global.password')]) }}' }
                                        }">
                            ...
                            <div class="admin-user-field mdl-grid">
                                ...
                                <div class="mdl-cell mdl-cell--9-col">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" v-bind:class="{'is-invalid': $validator.password_confirmation.errors && $validator.password_confirmation.touched}">
                                        <input class="mdl-textfield__input" type="password" id="user-password-confirmation" v-model="user.password_confirmation" v-validate:password_confirmation="{
                                            required: {rule: true, message: '{{ trans('validation.required', ['attribute' => trans('global.password_confirmation')]) }}' }
                                        }">
