<?php return [
    ...
    'settings_general_email_fields_address_label' => 'Email Address',
    'settings_general_email_fields_address_description' => 'This is the email address used for every part of your site, and also a fallback for any emails where a from address isn\'t defined.',
    ...
    'settings_general_time_fields_timezone_label' => 'Timezone',
    'settings_general_time_fields_timezone_description' => 'The timezone set here will effect all parts of your application.',

    'settings_general_time_fields_date_format_label' => 'Date Format',
    'settings_general_time_fields_date_format_description' => 'The date format set here will effect all parts of your application.',
    ...
    'settings_general_environment_fields_debug_label' => 'Debug',
    'settings_general_environment_fields_debug_description' => "When enabled uncaught exceptions, stack traces and general debugging information is displayed.\nNot recommended in production as sensitive data is visible.",
    ...
    'settings_user_description' => 'This section contains settings related to user creation, usage, management, etc.',

    'settings_user_registration_title' => 'Registration Settings',
    'settings_user_registration_description' => 'Set User Registration settings which best suit your site.',

    'settings_user_registration_fields_enabled_label' => 'Enable Registration',
    'settings_user_registration_fields_enabled_description' => 'Can Users register on your website?',
];